 ...
 * @author florian
 */
public class NTTRabinShare extends Share {
    ...
    /**
     * a Rabin share using NTT with Information Checking
     */
    public NTTRabinShare(byte id, byte[] body, ICType ic, Map<Byte, byte[]> macKeys, Map<Byte, byte[]> macs,
    ...
    /**
     * a Rabin share using NTT without Information Checking
     */
    public NTTRabinShare(byte id, byte[] body, int originalLength, int nttShareSize) throws InvalidParametersException {
        super(id, body);
        this.originalLength = originalLength;
        this.nttShareSize = nttShareSize;
    }
