...
/* TODO: maybe implement efficient polynomial-division here */

/**
 * This class represents a simple polynomial in GF(256) and provides basic functionality like evaluating points.
 * 
 * Since this class uses the methods of {@link GF256Math}, the same rules apply for using this class.
 *  
...
public class GF256Polynomial {
	...
	public int evaluateAt(int x) {
		...
		for (int i = degree - 1; i >= 0; i--)
		    result = GF256Math.mult(result, x) ^ coeffs[i];
		return result;
	}
}